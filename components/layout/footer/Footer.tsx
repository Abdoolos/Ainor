                    ...
                    <div className="container-fluid">
                        <div className="container position-relative z-2">
                            <div className="py-120 d-flex flex-wrap gap-4 justify-content-between">
                                <div>
                                    <h3 className="text-primary btn-text pb-3">Populære Tema</h3>
                                ...
                                <div>
                                    <h3 className="text-primary btn-text pb-3">SELSKAP</h3>
                                    <div className="d-flex flex-column align-items-start">
                                        <Link href="#">
                                            <p>Om Oss</p>
                                        </Link>
                                ...
                                <div>
                                    <h3 className="text-primary btn-text pb-3">Hjelp</h3>
                                    <div className="d-flex flex-column align-items-start">
                                        <Link href="#">
                                            <p>Kundestøtte</p>
                                        </Link>
                                        <Link href="#">
                                            <p>Leveringsdetaljer</p>
                                        </Link>
                                        <Link href="#">
                                ...
                                <div>
                                    <h3 className="text-primary btn-text pb-3">Tjenester</h3>
                                    <div className="d-flex flex-column align-items-start">
                                        <Link href="#">
                                            <p>Nettside Design</p>
                                        </Link>
                                        <Link href="#">
                                            <p>Forretningsrådgivning</p>
                                        </Link>
                                        <Link href="#">
                                            <p>Økonomi &amp; Finans</p>
                                        </Link>
                                ...
                                <div>
                                    <h3 className="text-primary btn-text pb-3">Få daglige oppdateringer</h3>
                                    <form action="#" className="input-group mb-3 mt-4 position-relative">
                                        <div className="row">
                                            <div className="col-12">
                                                <input type="text" className="py-3 form-control email rounded-4 border-0" name="email" placeholder="Skriv inn din e-post" />
