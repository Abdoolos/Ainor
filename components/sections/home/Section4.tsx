                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12 pe-lg-8">
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <span className="btn-text text-primary">Vanlige Spørsmål</span>
                            </div>
                            <h2 className="text-dark mt-3 mb-8 text-anime-style-2">Finn svar på alle spørsmål her</h2>
                                    ...
                                    <div className="p-0 card-header border-0 rounded-3 bg-white">
                                        <Link className="collapsed p-3 fw-bold d-flex align-items-center" data-bs-toggle="collapse" href="#collapse-1">
                                            <h6 className="text-primary fs-6 mb-0">
                                                Spm. <span className="text-dark">Hvilke støtte- og servicepakker er tilgjengelige?</span>
                                            </h6>
                                            <span className="ms-auto arrow" />
                                        </Link>
                                    </div>
                                    <div id="collapse-1" className="collapse" data-bs-parent=".accordion">
                                        <p className="px-3 fs-6 fw-regular">Vi tilbyr et utvalg av støtte- og servicepakker tilpasset ulike behov, fra grunnleggende assistanse til omfattende løsninger. Kontakt vårt salgsteam for mer informasjon.</p>
                                    </div>
                                </div>
                                <div className="px-0 py-3 card border-0 border-top border-bottom rounded-0 mb-3 collapse-custom" data-aos="fade-up" data-aos-delay={200}>
                                    <div className="p-0 card-header border-0 rounded-3 bg-white">
                                        <Link className="p-3 fw-bold d-flex align-items-center" data-bs-toggle="collapse" href="#collapse-2">
                                            <h6 className="text-primary fs-6 mb-0">
                                                Spm. <span className="text-dark">Hvordan kan jeg betale?</span>
                                            </h6>
                                            <span className="ms-auto arrow" />
                                        </Link>
                                    </div>
                                    <div id="collapse-2" className="collapse show" data-bs-parent=".accordion">
                                        <p className="px-3 fs-6 fw-regular">Vi tilbyr flere betalingsalternativer inkludert kredittkort, bankoverføring og faktura. Kontakt oss for å diskutere den beste løsningen for deg.</p>
                                    </div>
                                </div>
                                <div className="px-0 py-3 card border-0 border-top border-bottom rounded-0 mb-3 collapse-custom" data-aos="fade-up" data-aos-delay={400}>
                                    <div className="p-0 card-header border-0 rounded-3 bg-white">
                                        <Link className="collapsed p-3 fw-bold d-flex align-items-center" data-bs-toggle="collapse" href="#collapse-3">
                                            <h6 className="text-primary fs-6 mb-0">
                                                Spm. <span className="text-dark">Tilbyr dere refusjon?</span>
                                            </h6>
                                            <span className="ms-auto arrow" />
                                        </Link>
                                    </div>
                                    <div id="collapse-3" className="collapse" data-bs-parent=".accordion">
                                        <p className="px-3 fs-6 fw-regular">Ja, vi har en 30-dagers refusjonsgaranti på våre tjenester hvis du ikke er fornøyd. Ta kontakt med kundeservice for detaljer.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
