                ...
                <div className="container position-relative z-1">
                    <div className="row align-items-center">
                        <div className="col-lg-6 d-none d-lg-block wow img-custom-anim-top">
                            <img className="zoom-img" src="assets/imgs/pages/ai-solutions/page-about/img-1.png" alt="Ainorab" />
                        </div>
                        <div className="col-lg-6 col-md-12 order-2 ">
                            <div className="d-flex align-items-center gap-3">
                                <span className="small-line" />
                                <span className="btn-text text-primary">om oss</span>
                            </div>
                            <h2 className="text-dark my-3 text-anime-style-3">Forme morgendagen med AI og robotikk</h2>
                            <p className="pb-4 text wow img-custom-anim-top">Hos Ainorab - AI er vi dedikert til å transformere verden gjennom banebrytende kunstig intelligens-løsninger. Med fokus på innovasjon, presisjon og innvirkning, gir vi bedrifter og enkeltpersoner muligheten til å oppnå enestående effektivitet og suksess.</p>
                            <ul className="list-unstyled d-flex flex-wrap wow img-custom-anim-top">
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Tilpasset AI-utvikling</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                ...
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Maskinlæringsløsninger</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Naturlig språkbehandling</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">AI-drevet dataanalyse</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Robotisert prosessautomatisering</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Datasyn-systemer</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">AI-rådgivning &amp; strategi</p>
                                </li>
                            </ul>
