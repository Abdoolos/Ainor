...
const teamMembers = [
    { delay: "0", img: "abd1.jpg", linkAuthor: "#", name: "Abdullah Alawiss", role: "AI utvikler og UX designer" }
];
                    ...
                    <div className="row align-items-end mb-8">
                        <div className="col-lg-7">
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <span className="btn-text text-primary">Møt vårt team</span>
                            </div>
                            <h2 className="text-dark my-3 text-anime-style-3">Møt innovatørene som former fremtidens teknologi</h2>
                        </div>
